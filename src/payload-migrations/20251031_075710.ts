...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "mapping_instance_and_stage" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"stage_id" varchar,
  	"instance_id" varchar,
  	"gs_created_at" varchar,
  ...
  CREATE TABLE "mapping_navigation_section" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"entity_id" varchar,
  	"section_id" varchar,
  	"gs_created_at" varchar,
  ...
  CREATE TABLE "payload_locked_documents_rels" (
  	...
  	"e_stage_id" integer,
  	"exams_id" integer,
  	"mapping_instance_and_stage_id" integer,
  	"mapping_navigation_section_id" integer,
  	"media_id" integer,
  	"pages_id" integer,
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_e_label_fk" FOREIGN KEY ("e_label_id") REFERENCES "public"."e_label"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_mapping_instance_and_stage_fk" FOREIGN KEY ("mapping_instance_and_stage_id") REFERENCES "public"."mapping_instance_and_stage"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_mapping_navigation_section_fk" FOREIGN KEY ("mapping_navigation_section_id") REFERENCES "public"."mapping_navigation_section"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "e_label_updated_at_idx" ON "e_label" USING btree ("updated_at");
  CREATE INDEX "e_label_created_at_idx" ON "e_label" USING btree ("created_at");
  ...
  CREATE INDEX "mapping_instance_and_stage_updated_at_idx" ON "mapping_instance_and_stage" USING btree ("updated_at");
  CREATE INDEX "mapping_instance_and_stage_created_at_idx" ON "mapping_instance_and_stage" USING btree ("created_at");
  CREATE INDEX "mapping_navigation_section_updated_at_idx" ON "mapping_navigation_section" USING btree ("updated_at");
  CREATE INDEX "mapping_navigation_section_created_at_idx" ON "mapping_navigation_section" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_e_label_id_idx" ON "payload_locked_documents_rels" USING btree ("e_label_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_mapping_instance_and_stage_idx" ON "payload_locked_documents_rels" USING btree ("mapping_instance_and_stage_id");
  CREATE INDEX "payload_locked_documents_rels_mapping_navigation_section_idx" ON "payload_locked_documents_rels" USING btree ("mapping_navigation_section_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "e_label" CASCADE;
  DROP TABLE "e_navigation" CASCADE;
  DROP TABLE "e_sections" CASCADE;
  DROP TABLE "e_stage" CASCADE;
  DROP TABLE "exams" CASCADE;
  DROP TABLE "mapping_instance_and_stage" CASCADE;
  DROP TABLE "mapping_navigation_section" CASCADE;
