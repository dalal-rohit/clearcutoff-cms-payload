...
This project is built on Payload CMS. A dedicated skill lives at `.Codex/skills/payload/`.
Start with `.Codex/skills/payload/SKILL.md` for a quick reference, then see `.Codex/skills/payload/reference/` for detailed docs (fields, collections, hooks, access control, queries, adapters, plugins).
